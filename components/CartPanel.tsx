            ...
            <div className="flex gap-4 group">
              ...
              <div className="flex-1 flex flex-col justify-between py-0.5">
                <div className="flex justify-between items-start gap-2">
                  ...
                  <button className="text-neutral-300 hover:text-red-500 active:scale-90 transition-all focus:outline-none" aria-label="Remove item">
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <div className="flex items-center gap-3">
                    <button className="w-6 h-6 rounded-full border border-neutral-200 flex items-center justify-center text-neutral-400 hover:text-black hover:border-black active:scale-90 transition-all focus:outline-none">
