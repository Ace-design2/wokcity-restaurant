...
export default function Sidebar({ 
  ...
  const links = [
    ...
    { name: 'Performance', href: '/admin/performance', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  ...
  return (
    ...
    `}>
      <div className="p-6">
        ...
        <div className="text-xs font-bold text-neutral-400 uppercase tracking-widest mt-1">Admin Panel</div>
      </div>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-sm ${
                isActive 
                  ...
                  : 'text-neutral-600 hover:bg-neutral-50 hover:text-black border-l-4 border-transparent'
              }`}
            >
      ...
      <div className="p-4 border-t border-neutral-100 mt-auto">
        <Link 
          href="/admin"
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-neutral-600 hover:bg-neutral-50 hover:text-red-600 transition-all font-medium text-sm border-l-4 border-transparent hover:border-red-600"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
